...
class BaseHandler {
	...
	setUpCapture(screenshotsConfig){
		const screenshotsPath = screenshotsConfig.path
		const enable = screenshotsConfig.enable
		if (enable && !fs.existsSync(screenshotsPath)){
